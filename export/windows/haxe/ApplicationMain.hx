...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TurnBaseRPG", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TurnBaseRPG", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TurnBaseRPG";
		app.meta["name"] = "TurnBaseRPG";
